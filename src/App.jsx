...
export default function App() {
  ...
  const renderPage = () => {
    switch (page) {
      case 'dashboard':
        return <Dashboard cultivoId={cultivoId} />
      ...
      case 'mediciones':
        return <Mediciones cultivoId={cultivoId} />

      case 'ia':
        return <AnalisisIA cultivoId={cultivoId} />

      case 'alertas':
        return <Alertas cultivoId={cultivoId} />
